...
{ 
	/*for(count = 0; count < terms.length; count++) {
		...
		for(count1 = 0; count1 < 10; count1++) {
			start = count1 * 10 + 1;*/
			var query = 'http://walmartlabs.api.mashery.com/v1/search?format=json&categoryId=5427&apiKey=8zau4f9bfyqrk6a8bbzw3qpm&';
			/*http://walmartlabs.api.mashery.com/v1/search?format=json&categoryId=5427&apiKey=nf29te4xjwrkv8bub2sxqjx2&*/
			/*http://api.walmartlabs.com/v1/search?format=json&categoryId=5427&apiKey=8zau4f9bfyqrk6a8bbzw3qpm&*/
			query+= 'query='+'diapers'+'&'+'start='+ '71';
...
var getProduct = function(req, res) {
	...
	var query = 'http://api.walmartlabs.com/v1/items/'+req.params.product_id+'?apiKey=8zau4f9bfyqrk6a8bbzw3qpm&format=json';
	/*http://api.walmartlabs.com/v1/items/'+req.params.product_id+'?apiKey=nf29te4xjwrkv8bub2sxqjx2&format=json*/
	/*var query = 'http://api.walmartlabs.com/v1/items/'+req.params.product_id+'?apiKey=8zau4f9bfyqrk6a8bbzw3qpm&format=json';*/
